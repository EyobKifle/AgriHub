...
<head>
    ...
    <title>My Profile - AgriHub</title>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <div class="main-header">
                <h1 data-i18n-key="user.profile.title">My Profile</h1>
                <p data-i18n-key="user.profile.subtitle">View and edit your personal information and farm details.</p>
            </div>
            ...
            <div class="profile-layout">
                ...
                <div class="card profile-picture-card">
                    ...
                    <div class="profile-picture-preview"><img src="https://placehold.co/150x150/cccccc/FFF?text=?" alt="Current profile picture" id="profile-image-preview"></div>
                ...
                <div class="card profile-details-card">
                    <div id="form-status-message" style="margin-bottom: 1rem;"></div>
                    <form id="profile-form" class="settings-form" enctype="multipart/form-data">
                        <input type="file" id="avatar-upload" name="avatar" accept="image/*" style="display:none;">
                        <input type="hidden" name="existing_avatar_url" id="existing_avatar_url" value="">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="tel" id="phone" name="phone" value="" placeholder="+251 9...">
                            </div>
                            <div class="form-group">
                                <label for="location" data-i18n-key="user.profile.details.location">Location / Region</label>
                                <input type="text" id="location" name="location" value="" placeholder="e.g., Amhara, Gojjam">
                            </div>
                        </div>
                        ...
                        <div class="form-grid">
                             <div class="form-group">
                                ...
                                <input type="number" step="0.1" id="farm-size" name="farm_size_hectares" value="" placeholder="e.g., 5.5">
                            </div>
                            <div class="form-group">
                                <label for="experience">Years of Experience</label>
                                <input type="number" id="experience" name="experience_years" value="" placeholder="e.g., 10">
                            </div>
                        </div>
                         <div class="form-group">
                            <label for="specialization">Specialization</label>
                            <input type="text" id="specialization" name="specialization" value="" placeholder="e.g., Grains, Dairy, Coffee">
                        </div>
                        <div class="form-group">
                            <label for="bio" data-i18n-key="user.profile.details.about">About Me / My Farm (Optional)</label>
                            <textarea id="bio" name="bio" rows="4" placeholder="Describe your farm, the crops you grow, or your farming practices..."></textarea>
                        </div>
                        <div class="form-group">
                            <label for="business-name">Business Name (Optional)</label>
                            <input type="text" id="business-name" name="business_name" value="">
                        </div>
                        <div class="form-group">
                            <label for="business-address">Business Address (Optional)</label>
                            <textarea id="business-address" name="business_address" rows="2"></textarea>
                        </div>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <select id="language-preference" name="language_preference">
                            ...
                            <div class="form-group">
                                ...
                                <select id="theme-preference" name="pref_theme">
